...
export default function Component({message} : MessageTabProps) {
  const {username, userlogo, text, verified} = message;
    return (
      <div className="flex flex-col h-fit border rounded-lg w-[20rem] md:w-[30rem]  dark:border-gray-800 backdrop-blur-3xl bg-[#1F2937] bg-opacity-50 ">
        <div className="flex-1 p-4 overflow-scroll grid gap-4 text-sm dark:bg-gray-950">
