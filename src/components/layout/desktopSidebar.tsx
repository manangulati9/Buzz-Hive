...
const PcSidebar = () => {
  ...
  return (
    // <div className="sidebar container fixed left-[50%] top-0 z-0 mx-auto hidden h-screen w-full max-w-7xl md:block">
    <div className="fixed z-50 hidden w-full max-w-sm md:block md:max-w-xs">
