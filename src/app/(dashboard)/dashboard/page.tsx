  ...
  return (
    <div className='min-h-screen mx-auto justify-around py-10 text-foreground flex container w-full max-w-none relative'>
      <div className=' w-full  '>
        <div className='mx-auto w-[18rem]  md:w-full max-w-xl  h-fit drop-shadow-[0_0_35px_rgba(1,1,1,1.25)]  rounded-xl flex  justify-between py-2 px-6 my-5 md:backdrop-blur-3xl bg-[#1F2937] bg-opacity-50'>
      ...
      <div className='md:flex flex-col items-center hidden fixed right-8  md:w-full max-w-sm'>
