...
import { EarthIcon, Hand, MessageCircle, Smile, Stars } from 'lucide-react'
...
function page() {
  ...
  return (
    <div className='min-h-screen mx-auto justify-between py-10 text-white flex'>
      ...
      <div className='mx-auto w-[18rem]  md:w-[30rem]  h-fit drop-shadow-[0_0_35px_rgba(1,1,1,1.25)]  rounded-xl flex  justify-between py-2 px-6 my-5 backdrop-blur-3xl bg-[#1F2937] bg-opacity-50'>
        <p className='font-bold'>
          Latest Buzz
        </p>
        <Stars color='yellow' />
      </div>
      <div className='mx-auto w-[18rem]  md:w-[30rem] h-fit drop-shadow-[0_0_35px_rgba(1,1,1,1.25)]  rounded-lg flex flex-col justify-between py-2 px-2 space-y-4 my-10 backdrop-blur-3xl bg-[#1F2937] bg-opacity-50'>
